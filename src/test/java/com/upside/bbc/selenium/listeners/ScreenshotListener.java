package com.upside.bbc.selenium.listeners;
...
// screenshots are stored on target/screenshots

public class ScreenshotListener extends TestListenerAdapter {

    public static final Logger LOG = LoggerFactory.getLogger(ScreenshotListener.class);
